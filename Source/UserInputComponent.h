...
{
public:
	UserInputComponent(Object* owner, ResourceManager* devices, InputDevice::UserInputs TriggeredInput);
...
//	//std::map<InputDevice::UserInputs, UserInputComponent::Running> pressControl;
